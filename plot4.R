...
legend(length(data2$Sub_metering_1)-1600,40, c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), cex=0.8, 
...
plot(data2$Global_reactive_power,type='l',ylab='Global Reactive Power',xlab='datetime',xaxt='n',col="black")
